...
def generate_launch_description():
    ...
    params_directory= os.path.join(prefix_address, 'config', 'nav2_dwb_params.yaml')
    map_directory = os.path.join(get_package_share_directory('bal_robot_bringup'), 'maps','room2.yaml')
